...
{
    public class TicketService(ITicketRepository ticketRepository, IUnitOfWork unitOfWork, IMapper mapper) : Service<Ticket, TicketDto>(ticketRepository, unitOfWork, mapper), ITicketService
    {
    }
}
